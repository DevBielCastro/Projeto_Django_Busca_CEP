...
class CepCreateView(FormView):
    template_name = 'form_cep.html'  # Atualizado
    form_class = cepForm
...
class CepListView(ListView):
    model = CepModel
    template_name = 'crud/lista_cep.html'  # Atualizado


class CepUpdateView(UpdateView):
    model = CepModel
    fields = ['cep', 'cidade']
    template_name = 'crud/form_cep.html'  # Atualizado
    success_url = reverse_lazy('lista_cep')


class CepDeleteView(DeleteView):
    model = CepModel
    template_name = 'crud/deleta_cep.html'  # Atualizado
    success_url = reverse_lazy('lista_cep')
class CepListView(ListView):
    model = CepModel
